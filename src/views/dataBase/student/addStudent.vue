      ...
      <div class="my-tinymce-container">
        ...
        <div class="question-item-container">
          <div class="question-item-box">
            <span class="my-label"><span class="start">*</span>学生姓名：</span>
            <el-input class="my-el-select-container" v-model="studentname" size="mini"
        ...
        <div class="question-item-container">
          <div class="question-item-box">
            <span class="my-label"><span class="start">*</span>学生学号：</span>
            <el-input class="my-el-select-container" v-model="studentcode" size="mini"
                      placeholder="请输入学生学号"></el-input>
          </div>
          <div class="question-item-box">
            <span class="my-label"><span class="start">*</span>身份证号：</span>
            <el-input class="my-el-select-container" v-model="idcard" size="mini" minlength="18" maxlength="18"
        ...
        <div class="question-item-container">
          <div class="question-item-box">
            <span class="my-label"><span class="start">*</span>照片：</span>
            <el-upload
    ...
    methods:{
      ...
      async fSubmit(){
        if(!this.studentname.trim()){
          return global.showMessage('请输入学生姓名');
        }
        if(!this.mobile.trim()){
          return global.showMessage('请输入联系电话');
        }
        if(!this.studentcode.trim()){
          return global.showMessage('请输入学生编号');
        }

        if(!this.idcard.trim()){
          return global.showMessage('请输入身份证号');
        } else if(this.idcard.trim().length !== 18){
          return global.showMessage('请输入长度为18位的身份证号');
        }

        let sex = global.getSexByIdNO(this.idcard.trim());

        if(!this.imgUrl){
          return global.showMessage('请上传照片');
        }
        ...
        this.$emit('transferEvt', { method: 'fSubmitAddStudent', data: param })
      },
