<template>
  <div class="exam-question-item">
    ...
    <div class="exam-question-item-answer">
      <span>你的选择：</span>
      <span v-for="(listli, index) in data.optionList" class="exam-question-item-answer-num">
        <el-radio v-model="radio" :label="listli" @change="answerChange">{{formatterNum(index + 1)}}</el-radio>
      </span>
    </div>
  </div>
</template>
